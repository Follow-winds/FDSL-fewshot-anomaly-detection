...
# your MVTEC DATABASE path
MVTEC_PATH = './data/mvtec'


class MVTecSolver(object):
    CLSNAMES = [
        'bottle', 'cable', 'capsule', 'carpet_textture', 'grid_textture',
        'hazelnut', 'leather_textture', 'metal_nut', 'pill', 'screw',
        'tile_textture', 'toothbrush', 'transistor', 'wood_textture', 'zipper_textture',
    ]
...
if __name__ == '__main__':
    runner = MVTecSolver(root=MVTEC_PATH)
    runner.run()
